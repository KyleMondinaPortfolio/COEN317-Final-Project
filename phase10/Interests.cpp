...
void Interests::add(int guid, std::string interest, std::string address){
	if(interests[interest].count(guid)){
		//already in here do nothing
	}else{
		interests[interest].insert(std::pair<int,std::string>(guid,address));
	}
}

void Interests::remove(int guid, std::string interest, std::string address){
	if(interests[interest].count(guid)){
		interests[interest].erase(guid);	
	}else{
		//not in the interests, do nothing
	}
}


std::string Interests::format(){
